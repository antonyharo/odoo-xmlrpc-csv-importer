class ReferenceCache:
    ...
    def get_state_id_cached(self, *, country_id, state_name, get_state_id):
        ...
        state_id = get_state_id(country_id, state_name)
        if state_id:
            self.state_cache[state_cache_key] = state_id

        return state_id

    def get_country_id_cached(self, *, country_name, get_country_id):
    ...
    def get_contact_reference_ids(
        self, *, country_name: str, state_name: str, odoo_client
    ) -> tuple:
